...
import com.gohool.sellerbuyerapp.Model.Products;
import com.gohool.sellerbuyerapp.Prevalent.Prevalent;
import com.gohool.sellerbuyerapp.ViewHolder.ProductViewHolder;
    ...
    void onStart() {
        ...
        FirebaseRecyclerAdapter<Products, ProductViewHolder>adapter =
                new FirebaseRecyclerAdapter<Products, ProductViewHolder> (options) {
                    @Override
                    protected
                    void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model)
                    {
                    ...
                    @Override
                    public
                    ProductViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
